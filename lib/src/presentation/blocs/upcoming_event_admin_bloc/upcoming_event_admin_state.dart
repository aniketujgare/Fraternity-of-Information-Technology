...
class UpcomingEventAdminLoading extends UpcomingEventAdminState {}
...
class ImageUploadedInDBState extends UpcomingEventAdminState {
  final String imageUrl;

  const ImageUploadedInDBState({required this.imageUrl});
  @override
