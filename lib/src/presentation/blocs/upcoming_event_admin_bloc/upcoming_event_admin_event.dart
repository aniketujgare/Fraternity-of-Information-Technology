...
class UpcomingEventAdminSubmit extends UpcomingEventAdminEvent {
  ...
  const UpcomingEventAdminSubmit({required this.imageFile});
...
class UploadToDBEvent extends UpcomingEventAdminEvent {
  final UpcomingEventModel eventModel;
  const UploadToDBEvent({required this.eventModel});
